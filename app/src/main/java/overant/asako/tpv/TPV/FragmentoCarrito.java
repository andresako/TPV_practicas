        ...
        if (!pa.carrito.isCerrado()) {
            switch (item.getItemId()) {
                ...
                case R.id.accion_carro_cerrar:
                    ...
                    if (!pa.carrito.isCerrado()) {
                        alert = new AlertDialog.Builder(getActivity());
                        alert.setTitle("ATENCION!\nVas a cerrar este ticket");
                        alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int whichButton) {
                                        pa.carrito.cerrarCarro();
                                        total.setText("0 €");
                                        AdaptadorCarrito adapter = new AdaptadorCarrito(total, pa);
                                        reciclador.setAdapter(adapter);
                                    }
                ...
                case R.id.accion_carro_detalles:
                    ...
                    TextView detId = new TextView(pa);
                    detId.setText("ID: " + pa.carrito.getID());
